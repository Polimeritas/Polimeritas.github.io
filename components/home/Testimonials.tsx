...
const Testimonials = () => {
    const testimonials = [
        ...
        },
        {
            ...
            name: "Akhyarni Manaf",
            role: "Pekerja",
            image: "/img/Partner2/Akhyarni Manaf.jpg",
            quote: "Terimakasih dan sukses selalu untuk polimeritas.",
        },
            {
            id: 23,
            name: "Suksma S",
            ...
            {
            id: 24,
            name: "Azura Aulia Azahra",
            role: "Pekerja",
            image: "/img/Partner2/azura aulia azahra.jpg",
            quote: "Terimakasih saya banyak belajar disini, sukses selalu.",
        },
            {
            id: 25,
            name: "Salma Amaliani Putri",
            role: "Pekerja",
            image: "/img/Partner2/salma amaliani putri.jpg",
            quote: "Semoga baik baik dan banyak yang bergabung kedepannya.",
        },
            {
            id: 26,
            name: "Eka Fredhita",
            role: "Pekerja",
            image: "/img/Partner2/Eka Fredhita.jpg",
            quote: "Semangat dan sukses selalu untuk polimeritas.",
        },
            {
            id: 27,
            name: "Alifa Syifa'ul Qolbi",
            role: "Pekerja",
            image: "/img/Partner2/Alifa Syifa'ul Qolbi.jpg",
            quote: "Terimakasih saya banyak belajar disini sukses dan jaya selalu.",
        },
            {
            id: 8,
