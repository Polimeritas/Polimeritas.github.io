...
const FloatingWidgets = () => {
    ...
    return (
        <>
            ...
            <button
                onClick={scrollToTop}
                className={`${isVisible ? "opacity-100 visible translate-y-0" : "opacity-0 invisible translate-y-10"
                    } fixed bottom-8 right-8 z-[99] w-10 h-10 lg:w-12 lg:h-12 bg-primary text-dark flex items-center justify-center rounded shadow-lg hover:bg-secondary hover:text-white transition-all duration-500`}
            >
