...
export const polymerMatchData: PolymerData[] = [
  {
    m: "Ethene",
    mf: "CH₂=CH₂",
    p: "Polyethylene",
    pf: "[-CH₂–CH₂-]ₙ",
    a: "Kantong plastik / kemasan",
    type: "addition",
  },
  {
    m: "Propene",
  ...
  {
    m: "Ethylene glycol + terephthalic acid",
    mf: "HO–CH₂–CH₂–OH + HOOC–C₆H₄–COOH",
    p: "PET",
    pf: "Poly(ethylene terephthalate)",
    a: "Botol minuman / serat",
    type: "condensation",
  },
  {
    m: "Hexamethylenediamine + adipic acid",
    mf: "Diamine + diacid",
    p: "Nylon-6,6",
    pf: "[-NH-(CH₂)₆-NH-CO-(CH₂)₄-CO-]ₙ",
    a: "Serat / tekstil",
    type: "condensation",
  },
];
